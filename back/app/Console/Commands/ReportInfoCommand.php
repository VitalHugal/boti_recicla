...
class ReportInfoCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:report_info';
     ...
     * @var string
     */
    protected $description = 'Generate participation report';
    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ($users as $user) {
                ...
                $participations = Participation::where('fk_user_id', $user->id)->first();
                if (!$participations) {
                    continue;
                }
                ...
                DB::table('report_info')->insert([
                    'name' => $name,
                    'cpf' => $cpf,
                    'email' => $email,
                    'name_product' => $product->name ?? null,
                    'quantity' => $exits->qtd ?? null,
